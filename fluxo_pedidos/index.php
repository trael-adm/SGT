...
<head>
    ...
    <title>Mapa do Caminho do Pedido | SGT</title>
...
<body>
    ...
    <div class="fp-wrapper">
        ...
        <header class="top-header">
            <div class="top-brand">
                ...
                <div class="brand-info">
                    <h1>Fluxo do Pedido & Esteira Industrial (2026)</h1>
        ...
        <section class="metrics-row">
            <div class="metric-card accent">
                <div class="metric-label">Carteira Ativa (2026)</div>
    ...
    <!-- Script Oficial do Mapa -->
    <script src="assets/js/mapa.js?v=<?= file_exists(__DIR__ . '/assets/js/mapa.js') ? filemtime(__DIR__ . '/assets/js/mapa.js') : time() ?>"></script>
</body>
</html>
