...
foreach ($diasDoMes as $d) {
    ...
    if ($execDia === 0 && $ultimaDataProducao !== null && $d > $ultimaDataProducao) {
...
<?php 
$pctMetaMensal = $metaTotalForca > 0 ? round(($totalRealAteHoje / $metaTotalForca) * 100, 1) : 0;
?>
...
<div class="bo-kpis-grid-5" style="margin-bottom:16px;">
    ...
    <div class="metric-card" style="border-left: 4px solid #dc2626;">
        ...
        <div class="metric-sub">unidades (almox. 422) · média <?= htmlspecialchars(fmtDecimal($mediaDiariaLab)) ?> un/dia</div>
    </div>
    <div class="metric-card" style="border-left: 4px solid var(--color-primary);background:var(--color-surface);position:relative;">
        ...
        <div class="metric-sub" style="margin-bottom:6px;">total no mês · meta <?= (int) $metaTotalForca ?> un</div>
        <?php if ($metaTotalForca > 0): ?>
        ...
        <div style="border-top:1px solid var(--color-border);padding-top:12px;margin-top:8px;">
            <div class="bo-table-wrap">
                <table class="bo-nucleo-table">
                    <thead>
                        <tr>
                            <th style="vertical-align:bottom;padding-bottom:8px;">Linha</th>
                            <?php 
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="background:var(--color-surface-2);font-weight:600;<?= $totalCore[$c]['real'] > 0 ? 'cursor:pointer;' : '' ?>" <?= $totalCore[$c]['real'] > 0 ? "onclick=\"abrirModalDetalhesPecas('', '" . $c . "')\" title=\"Clique para ver todas as peças desta linha no mês\"" : "" ?>><?= (int) $totalCore[$c]['real'] ?></td>
                        </tr>
                        <?php endforeach; ?>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="background:var(--color-surface-2);font-weight:700;color:var(--color-accent-text);"><?= $metaTotalForca > 0 ? (int) $metaTotalForca : '—' ?></td>
                        </tr>
                        <tr>
                            ...
                            ?>
                                <td data-dia="<?= $d ?>" class="<?= $v === null ? 'bo-zero' : '' ?>"><?= $v !== null ? htmlspecialchars(fmtDecimal($v)) : '—' ?></td>
                            <?php endforeach; ?>
                        </tr>
                    </tbody>
                </table>
