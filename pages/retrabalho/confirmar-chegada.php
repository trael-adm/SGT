        ...
        <div style="padding: 20px;">
            ...
            <div class="barcode-box" id="barcodeBox">
                ...
                <div id="wrapInputManual" style="display:none;width:100%;max-width:380px;margin:0 auto;">
                    <form id="formChegadaBarcode" onsubmit="event.preventDefault(); submeterChegadaManual();" style="display:flex;flex-direction:column;align-items:center;gap:10px;">
                        <input type="text" 
                               id="inputBarcodeNs" 
                               class="barcode-input" 
                        ...
                        <div style="display:flex;gap:8px;width:100%;justify-content:center;">
                            <button type="submit" class="btn btn-primary" id="btnConfirmarChegada" style="padding:8px 20px;font-weight:700;font-size:13px;">
