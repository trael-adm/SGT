...
$canEdit = podeEditar('iqf.ret') || isAdmin();
...
if ($retornos) {
    ...
    $stmtRep = $pdo->prepare("
        ...
        WHERE r.deleted_at IS NULL
          AND (r.estacao = 'IQF' OR (r.setores_destino IS NOT NULL AND (FIND_IN_SET('inspecao_final', r.setores_destino) OR FIND_IN_SET('montagem_final', r.setores_destino))))
