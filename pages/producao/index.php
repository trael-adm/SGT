...
$canEdit = podeEditar('lab.reg') || isAdmin();
...
<div class="station-grid">
    ...
    <section class="station-card" id="labCard">
        <header class="station-card__head">
            <span class="station-pill" style="background:<?= $estacaoMap['LAB']['bg'] ?>;color:<?= $estacaoMap['LAB']['fg'] ?>;">LAB</span>
            <div>
                <h2>Laboratório</h2>
